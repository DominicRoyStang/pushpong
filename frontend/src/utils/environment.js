...
let ONLINE_MULTIPLAYER_ENABLED = false;

if (window.ONLINE_MULTIPLAYER_ENABLED === '__ONLINE_MULTIPLAYER_ENABLED__') {
    ONLINE_MULTIPLAYER_ENABLED = process.env.REACT_APP_ONLINE_MULTIPLAYER_ENABLED === 'true';
    window.ONLINE_MULTIPLAYER_ENABLED = ONLINE_MULTIPLAYER_ENABLED;
}
